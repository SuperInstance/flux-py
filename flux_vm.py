...
Features:
  ...
  - Opcodes: MOVI=0x2B, IADD=0x08, IMUL=0x0A, IDIV=0x0B, DEC=0x0F, JNZ=0x06, HALT=0x80
...
OPCODES = {
    'MOVI': 0x2B, 'IADD': 0x08, 'IMUL': 0x0A, 'IDIV': 0x0B,
